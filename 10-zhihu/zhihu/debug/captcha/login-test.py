...
class ZhiHu(object):
    ...
    def get_form_data(self, signature, captcha):
        # c3cef7c66a1843f8b3a9e6a1e3160e20&grant_
        text = "client_id=c3cef7c66a1843f8b3a9e6a1e3160e20&grant_type=password&timestamp={0}&" \
               ...
               "captcha={4}&lang=en&ref_source=homepage&utm_source=".format(self.timestamp, signature, self.phone,
    ...
    def login(self, encry):
        ...
        resp = self.session.post(url, headers=self.headers, data=encry)
        print(resp.text)
