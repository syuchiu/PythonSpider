        ...
        var d = {}, l = d.lib = {}, s = function () {
            ...
            r = l.WordArray = t.extend({
                ...
                stringify: function (a) {
                    ...
                    a = a.sigBytes;
                    for (var e = [], j = 0; j < a; j++) {
                        console.info("nocode:", c[j >>> 2] >>> 24 - 8 * (j % 4) & 255);
...
// console.info(_0xea12('0x9'),_0xea12('0xa')) String[prototype][endWith]
    ...
    console.info(_0xea12('0x10'), _0xea12('0x11'), _0xea12('0x12'));
//window location href
// console.info(top['window'][_0xea12('0x11')]['href'] )
    try {
...
// decrypt
//ƒ (b,k,d){return("string"==typeof k?c:a).decrypt(e,b,k,d)}
    console.info("AAA:", CryptoJS['AES'][_0xea12('0x14')])
// console.info("BBB",{
//     'iv': iv,
//     'padding': CryptoJS[_0xea12('0x0')][_0xea12('0x15')]
// })
    console.info(CryptoJS[_0xea12('0x0')][_0xea12('0x15')]);
    console.info("3:", iv);
    ...
    console.info("ccc:", CryptoJS['enc']['Utf8']);
...
// _0xea12('0x18') length
    ...
    var jsLast = function () {
        var _0x28d7f2 = {
            'NOyra': 'head', 'fgQCW': 'link', 'nCjZv': function _0x5de21d(_0x48b6d5, _0x51ba19) {
    ...
    for (var i = 0x0; i < words[_0xea12('0x18')]; i++) {
        try {
            console.info('.context_kw' + i + _0xea12('0x2c'), 'content:\x20\x22' + words[i] + '\x22')
